...
{
    [TestFixture]
    public class RegularIntervalTests
    {
        ...
        public void RegularIntervalDay(int year, int month, int day, int count, UnitOfTime unit, string date, bool expectedResult)
        {
            var expression = new RegularInterval(year, month, day, count, unit);
        ...
        public void RegularIntervalWeek(int year, int month, int day, int count, UnitOfTime unit, string date, bool expectedResult)
        {
            var expression = new RegularInterval(year, month, day, count, unit);
        ...
        public void RegularIntervalMonth(int year, int month, int day, int count, UnitOfTime unit, string date, bool expectedResult)
        {
            var expression = new RegularInterval(year, month, day, count, unit);
        ...
        public void RegularIntervalYear(int year, int month, int day, int count, UnitOfTime unit, string date, bool expectedResult)
        {
            var expression = new RegularInterval(year, month, day, count, unit);
